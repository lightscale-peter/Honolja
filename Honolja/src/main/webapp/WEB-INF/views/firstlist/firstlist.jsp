	...
	<div style="left:0; width:50% padding-left: 30px; padding-right:30px;padding-left:30px;">
		...
		<!-- Guest house 목록을 리스트로 뽑아주기 -->
      	...
      	<tr align="left" >
      		...
      		<a href="guestdetail.do?g_no=${list.g_no}&idx=${list.g_no}&check_in=${param.check_in}&check_out=${param.check_out}">
      		...
      		<td style="font-size:24px;padding-top:10px;"><a href="guestdetail.do?g_no=${list.g_no}&idx=${list.g_no}&check_in=${param.check_in}&check_out=${param.check_out}"> ${list.g_name}</a></td>
      	</tr>
