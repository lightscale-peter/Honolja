		...
		<form>
			<div class="form-group">
				<label for="usr">제목:</label> <input type="text" class="form-control"
					id="usr" readonly="readonly" value="${dto.b_title}"> <br>
				<label for="comment">Comment:</label>
				<textarea name="b_content" class="form-control" rows="10"
					id="comment" readonly="readonly">${dto.b_content}  </textarea>
			</div>
		</form>
		
		<c:if test="${dto.b_originalfilename  != null }">
			<img
				src='${pageContext.request.contextPath}/resources/upload/${img_file_name}'
